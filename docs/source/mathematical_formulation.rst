...
.. csv-table:: List of all Temoa sets with which a modeler might interact.  The
   ...
   ":math:`{}^*\text{C}^k`",":code:`commodity_sink`","string","end-use demands and waste commodities (:math:`\text{C}_d \cup \text{C}_w`)"
   ":math:`{}^*\text{C}^c`",":code:`commodity_carrier`","string","physical energy carriers and sinks (:math:`\text{C}_p \cup \text{C}_k`)"
