...
The ordering of the index sets is consistent throughout the model to promote an
...
is the canonical ordering. We use the word 'process' to refer to the tuple of
technology and vintage (:math:`\{t,v\}`). For example, solar PV (technology)
installed in 2030 (vintage).
