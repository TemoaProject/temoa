...
def temoa_create_model(name="Temoa"):
  ...
  """
    ...
    M.tech_groups =Set(within=M.RegionalIndices * M.groups * M.tech_all) # Define techs used in groups
    ...
    M.PlanningReserveMargin = Param(M.RegionalGlobalIndices, default=0)
    ...
    M.SegFracPerSeason = Param(M.time_seasons_per_period, initialize=SegFracPerSeason_rule)
    ...
    # Remove ramping constraint between seasons.
