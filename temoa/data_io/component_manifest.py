...
def build_manifest(model: TemoaModel, extension_ids: Sequence[str] | None = None) -> list[LoadItem]:
    ...
    manifest = [
        ...
        LoadItem(
            ...
            columns=['region', 'tech_or_group', 'margin'],
            validator_name='viable_rt',
            validation_map=(0, 1),
            is_period_filtered=False,
            is_table_required=False,
        ...
        LoadItem(
            component=model.operating_reserve_derate,
            table='operating_reserve_derate',
        ...
        LoadItem(
            component=model.operating_reserve_margin,
