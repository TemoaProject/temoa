...
GroupBuiltProcessesDict = dict[tuple[Region, Technology, Vintage], set[tuple[Region, Technology]]]
GroupActiveProcessesDict = dict[tuple[Region, Period, Technology], set[tuple[Region, Technology]]]
